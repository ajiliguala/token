...
namespace Kingdee.Wychl.Token.Business
{
	...
	[Description("直接调拨单反审核删除不良品拆解单插件")]
	public class Stk_StktransferinUnAudit : AbstractOperationServicePlugIn
	{
		// Token: 0x06000091 RID: 145 RVA: 0x0001018E File Offset: 0x0000E38E
		...
		// Token: 0x06000092 RID: 146 RVA: 0x000101BC File Offset: 0x0000E3BC
