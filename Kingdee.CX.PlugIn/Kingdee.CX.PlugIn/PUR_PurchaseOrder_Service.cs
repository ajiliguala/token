...
namespace Kingdee.CX.PlugIn
{
	...
	{
		// Token: 0x0600007B RID: 123 RVA: 0x00004ED0 File Offset: 0x000030D0
		...
		// Token: 0x0600007C RID: 124 RVA: 0x00004F00 File Offset: 0x00003100
						...
						if (flag3)
						{
							try
							{
								...
								if (flag4)
								{
									...
									text3 = Helper.BuildApiUrl(text3, PUR_PurchaseOrder_Service.API_DELETE_METHOD);
									...
									if (flag5)
									{
										strSQL = string.Format("update t_PUR_POOrder set F_SRMIDENT = '0' where FBILLNO= '{0}'", text);
		...
		// Token: 0x0600007D RID: 125 RVA: 0x000053DC File Offset: 0x000035DC
