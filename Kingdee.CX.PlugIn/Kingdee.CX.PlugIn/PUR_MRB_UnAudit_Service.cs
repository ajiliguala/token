...
namespace Kingdee.CX.PlugIn
{
	...
	{
		// Token: 0x06000076 RID: 118 RVA: 0x00004918 File Offset: 0x00002B18
		...
		// Token: 0x06000077 RID: 119 RVA: 0x00004948 File Offset: 0x00002B48
						...
						if (flag3)
						{
							try
							{
								...
								if (flag4)
								{
									...
									text3 = Helper.BuildApiUrl(text3, PUR_MRB_UnAudit_Service.API_DELETE_METHOD);
									...
									if (flag5)
									{
										strSQL = string.Format("update t_PUR_MRB set F_SRMIDENT = '0' where FBILLNO= '{0}'", text);
		...
		// Token: 0x06000078 RID: 120 RVA: 0x00004E24 File Offset: 0x00003024
