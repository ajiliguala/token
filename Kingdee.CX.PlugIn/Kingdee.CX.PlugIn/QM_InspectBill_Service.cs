...
namespace Kingdee.CX.PlugIn
{
	...
	{
		// Token: 0x0600008A RID: 138 RVA: 0x000067BA File Offset: 0x000049BA
						...
						if (flag3)
						{
							try
							{
								...
								if (flag4)
								{
									...
									text3 = Helper.BuildApiUrl(text3, QM_InspectBill_Service.API_DELETE_METHOD);
									...
									if (flag5)
									{
										strSQL = string.Format("update T_QM_INSPECTBILL set F_SRMIDENT = '0' where FBILLNO= '{0}'", text);
		...
		// Token: 0x0600008C RID: 140 RVA: 0x00006CC4 File Offset: 0x00004EC4
