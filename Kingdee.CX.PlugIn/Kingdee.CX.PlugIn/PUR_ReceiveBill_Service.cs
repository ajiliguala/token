...
namespace Kingdee.CX.PlugIn
{
	...
	{
		// Token: 0x06000080 RID: 128 RVA: 0x00005488 File Offset: 0x00003688
		...
		// Token: 0x06000081 RID: 129 RVA: 0x000054B8 File Offset: 0x000036B8
						...
						if (flag3)
						{
							try
							{
								...
								if (flag4)
								{
									...
									text3 = Helper.BuildApiUrl(text3, PUR_ReceiveBill_Service.API_DELETE_METHOD);
									...
									if (flag5)
									{
										strSQL = string.Format("update T_PUR_Receive set F_SRMIDENT = '0' where FBILLNO= '{0}'", text);
