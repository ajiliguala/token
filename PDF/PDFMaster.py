...
if __name__ == '__main__':
    ...
    root.title('PDF Master           Copyright © 2023 by LZH')
    root['bg'] = '#b4b4b4'
    root.attributes("-alpha", 0.97)

    lb0 = Label(root, text='拆分PDF模块', width=20, font='Helvetica -20 bold', bg='#b4b4b4')
    ...
    llb0 = Label(root, text='合并PDF模块', width=20, font='Helvetica -20 bold', bg='#b4b4b4')
