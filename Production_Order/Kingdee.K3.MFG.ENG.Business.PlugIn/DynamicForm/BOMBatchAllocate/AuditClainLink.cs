...
namespace Kingdee.K3.MFG.ENG.Business.PlugIn.DynamicForm.BOMBatchAllocate
{
	...
	public class AuditClainLink : AbstractClainLink
	{
		// Token: 0x06000721 RID: 1825 RVA: 0x00053678 File Offset: 0x00051878
		public override void DoOperation(Context ctx)
		{
			...
			IOperationResult operationResult = BusinessDataServiceHelper.Audit(ctx, base.BizInfo, array, OperateOption.Create());
			...
			AuditClainLink.<>c__DisplayClass9 CS$<>8__locals1 = new AuditClainLink.<>c__DisplayClass9();
			AuditClainLink.<>c__DisplayClass9 CS$<>8__locals2 = CS$<>8__locals1;
